...
It uses content-filtering to address the cold start problem and then Implicit ALS and NCF model for the rest. The purpose of this project was to do a comparison between the two models.
